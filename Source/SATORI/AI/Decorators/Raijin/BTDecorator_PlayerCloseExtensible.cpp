...
#include "AI/Decorators/Raijin/BTDecorator_PlayerCloseExtensible.h"
...
bool UBTDecorator_PlayerCloseExtensible::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
