...
#include "AnimNotify/State/SATORI_ANS_ComboLeftWeapon.h"
#include "AI/Character/Melee/SATORI_Melee.h"
#include "Components/Player/SATORI_ComboSystemComponent.h"
#include "Components/CapsuleComponent.h"

void USATORI_ANS_ComboLeftWeapon::NotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, float TotalDuration)
{
...
void USATORI_ANS_ComboLeftWeapon::NotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
